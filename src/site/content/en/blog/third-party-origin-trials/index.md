...
1. If review is required, you'll be notified by email when the review is complete and your
   ...
   <figure class="w-figure">
     <img src="tpot-registration.png" alt="Chrome origin trials registration page, with third-party matching checkbox selected.">
     <figcaption class="w-figcaption">Registration page for an API with third-party origin trial option.</figcaption>
   </figure>
